package fr.plb.ecom_product.shared.authentication.application;

import fr.plb.ecom_product.shared.authentication.domain.Role;
import fr.plb.ecom_product.shared.authentication.domain.Roles;
import fr.plb.ecom_product.shared.authentication.domain.Username;
...
public final class AuthenticatedUser {
    ...
    public static final String PREFERRED_USERNAME = "sub";
    ...
    public static List<String> extractRolesFromToken(Jwt jwtToken) {
        String roles = String.valueOf(jwtToken.getClaims().get("auth"));
